...
가장 자주 쓰게 될 명령어입니다. `specs/api/openapi.yaml` 설계도를 읽어서 프론트엔드/백엔드 통신 코드를 자동으로 만들어줍니다.
- **대화형 선택**: 명령어를 실행하면 어떤 언어로 생성할지 선택할 수 있습니다.
- **목록 확인**: 5번 옵션을 통해 사용 가능한 모든 언어(Generator) 목록을 확인할 수 있습니다.
